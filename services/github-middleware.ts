/**
 * GitHub Middleware for Node.js (V1.0)
 * Server-side implementation with full file system access
 */
...
export class ContinuityManager {
   ...
   */
  static loadCoreContext(basePath: string = '.'): Map<string, string> {
...
export class MeowstikMiddleware {
   ...
   */
  getCoreContext(basePath?: string): Map<string, string> {
